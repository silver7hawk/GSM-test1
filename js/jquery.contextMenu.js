...
var // currently active contextMenu trigger
    ...
    op = {
        ...
        create: function(opt, root) {
            ...
            // create contextMenu
            opt.$menu = $('<ul role="listbox" class="context-menu-list ' + (opt.className || "") + '"></ul>').data({
                'contextMenu': opt,
                ...
                if (typeof item == "string") {
                    ...
                    switch (item.type) {
                        ...
                        default:
                            ...
                            $('<a class="ui-corner-all" href="javascript:void(0);"><span></span></a>').html(item._name || item.name || "").appendTo($t);
